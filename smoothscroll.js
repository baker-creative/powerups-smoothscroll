(() => {
  ...
  // node_modules/.pnpm/lenis@1.1.9/node_modules/lenis/dist/lenis.mjs
  ...
  // src/powerups-smoothscroll/smoothscroll.js
  (() => {
    var _a, _b;
    const body = document.querySelector("body");
    const wrapper = document.querySelector("[data-bc-scroll]");
    const content = wrapper == null ? void 0 : wrapper.querySelector(":scope > *");
    const duration = !isNaN(parseFloat(body.dataset.bcScrollDuration)) ? parseFloat(body.dataset.bcScrollDuration) : 1;
    const orientation = (_a = body.dataset.bcScrollOrientation) != null ? _a : "vertical";
    const gestureOrientation = (_b = body.dataset.bcScrollGestureOrientation) != null ? _b : "vertical";
